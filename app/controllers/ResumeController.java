...
//import sun.tools.jar.resources.jar;
	...
	public class ResumeController {
		...
		public static JSONObject abb(String inputFile) {
			
		/*	String[] resumes = {"E:\\TestResumes\\resume2.docx","E:\\TestResumes\\resume3.docx","E:\\TestResumes\\resume4.docx",
					"E:\\TestResumes\\resume5.docx","E:\\TestResumes\\resume6.docx","E:\\TestResumes\\resume7.docx",
					"E:\\TestResumes\\resume8.docx"};
			String[] resumesOut = {"E:\\TestResumes\\resume2.json","E:\\TestResumes\\resume3.json","E:\\TestResumes\\resume4.json",
					"E:\\TestResumes\\resume5.json","E:\\TestResumes\\resume6.json","E:\\TestResumes\\resume7.json",
					"E:\\TestResumes\\resume8.json"};
			for(int i=0;i<resumes.length;i++)
			{
			String inputFileName = resumes[i]; 
			String outputFileName =resumesOut[i];
				*/
			Configuration conf = Play.application().configuration();
			System.setProperty("gate.home", "C:\\Program Files\\GATE_Developer_8.2");
			conf.getString("gate.home");
			JSONObject abc=new JSONObject();
			//String inputFileName = "E:\\Jyothi.docx"; 
			String outputFileName ="E:\\resume.json";
			
			try {
				File tikkaConvertedFile = parseToHTMLUsingApacheTikka(inputFile);
